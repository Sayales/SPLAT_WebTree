package com.sayales.webtree.config;
...
@Configuration
@EnableJpaRepositories("com.sayales.webtree.repository")
@EnableTransactionManagement
@PropertySource("classpath:db.properties")
@ComponentScan("com.sayales.webtree")
public class DatabaseConfig {
    ...
    private Properties getHibernateProperties() {
        try {
            ...
            throw new IllegalArgumentException("No prop in classpath!", e);
        }
    }
